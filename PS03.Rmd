...
Since LOOCV appears to underestimate the RMSE for increasing degrees of freedom, I decided to write a new function for $k=5$ fold cross validation called FiveFoldCV. As before, for this function to work, the data needs to have a 3 column format with colnames X, Y, and ID. I chose to test between $df=20$ and $df=40$, since the inflection points for LOOCV for both data1 and data2 appear to fall in this range.
```{r}
